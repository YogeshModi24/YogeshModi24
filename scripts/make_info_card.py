...
# ===========================================================================
HOST = "yogesh"   # shown as  yogesh@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "ML Intern @ FlyRank AI"),
    ("kv", "Edu", "B.Tech AI, Rishihood University '28"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Next.js, TypeScript"),
    ("kv", "Backend", "Node.js, Express, MongoDB"),
    ("kv", "AI / ML", "LangChain, LangGraph, RAG, GPT-4o Vision"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "ChemDirect - cut sourcing time 70% w/ LLM search"),
    ("bul", "CommunityOS - AI civic issue reporting platform"),
]
